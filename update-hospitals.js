...
const stripAddress = (address) => {
  ...
  result = result.replace('FIRST', '1ST')
  result = result.replace('SECOND', '2ND')
  result = result.replace('THIRD', '3RD')
  result = result.replace('FOURTH', '4TH')
  result = result.replace('FIFTH', '5TH')
  result = result.replace('SIXTH', '6TH')
  result = result.replace('SEVENTH', '7TH')
  result = result.replace('EIGHTH', '8TH')
  result = result.replace('NINTH', '9TH')
